...
@section('judul', 'DataKaryawan | DashboardAdmin')

@section('content')
    <center>
        <h1 style="font-family: 'Montserrat', sans-serif; padding-top:1rem; margin-bottom :3rem;">Tabel Karyawan</h1>
    </center>
    <div class="box-wrap">
        <div class="mb-5">
            <a href="/user-add" class="button" role="button" aria-pressed="true">Tambah Karyawan</a>
        </div>
